...
public class Controler {
    ...
    public void imprimirdatos(ActionEvent event) {
        ...
        System.out.println(hohenzollerndamm.getLayoutX() + " "+ hohenzollerndamm.getLayoutY());
        System.out.println(halensee.getLayoutX() + " "+ halensee.getLayoutY());
        System.out.println(westkreuz.getLayoutX() + " "+ westkreuz.getLayoutY());
        System.out.println(westend.getLayoutX() + " "+ westend.getLayoutY());
        System.out.println(beusselstr.getLayoutX() + " "+ beusselstr.getLayoutY());
        System.out.println(prenzlauerAllee.getLayoutX() + " "+ prenzlauerAllee.getLayoutY());
        System.out.println(greifswalderstr.getLayoutX() + " "+ greifswalderstr.getLayoutY());
        System.out.println(landsbergerAllee.getLayoutX() + " "+ landsbergerAllee.getLayoutY());
        System.out.println(storkowerstr.getLayoutX() + " "+ storkowerstr.getLayoutY());
    	System.out.println("---------------");
    	System.out.println(ostkreuz.getLayoutX() + " "+ ostkreuz.getLayoutY());
    	System.out.println(rummelsburgBhf.getLayoutX() + " "+ rummelsburgBhf.getLayoutY());
        System.out.println(betriebsbahnhofRummelsburg.getLayoutX() + " "+ betriebsbahnhofRummelsburg.getLayoutY());
        System.out.println(karlshorst.getLayoutX() + " "+ karlshorst.getLayoutY());
        ...
        System.out.println(humboldthain.getLayoutX() + " "+ humboldthain.getLayoutY());
        System.out.println(bornholmerstr.getLayoutX() + " "+ bornholmerstr.getLayoutY());
        System.out.println(wollankstr.getLayoutX() + " "+ wollankstr.getLayoutY());
        System.out.println("---------------");
    	System.out.println(rathausSteglitz.getLayoutX() + " "+ rathausSteglitz.getLayoutY());
    	System.out.println(schlossstr.getLayoutX() + " "+ schlossstr.getLayoutY());
	    ...
	    System.out.println(Birkenstr.getLayoutX() + " "+ Birkenstr.getLayoutY());
	    System.out.println(arumerstr.getLayoutX() + " "+ arumerstr.getLayoutY());
	    System.out.println(nauenerPlatz.getLayoutX() + " "+ nauenerPlatz.getLayoutY());
	    ...
	    System.out.println(voltastr.getLayoutX() + " "+ voltastr.getLayoutY());
	    System.out.println(berlinGesundbrunnen.getLayoutX() + " "+ berlinGesundbrunnen.getLayoutY());
	    System.out.println(pankstr.getLayoutX() + " "+ pankstr.getLayoutY());
	    System.out.println(osloerstr.getLayoutX() + " "+ osloerstr.getLayoutY());
	    System.out.println(franzNeumannPlatz.getLayoutX() + " "+ franzNeumannPlatz.getLayoutY());
	    System.out.println(residenzstr.getLayoutX() + " "+ residenzstr.getLayoutY());
	    System.out.println(paracelsusBad.getLayoutX() + " "+ paracelsusBad.getLayoutY());
	    System.out.println(lindauerAllee.getLayoutX() + " "+ lindauerAllee.getLayoutY());
	    ...
	    System.out.println(eisenacherstr.getLayoutX() + " "+ eisenacherstr.getLayoutY());
	    System.out.println(berlinerstr.getLayoutX() + " "+ berlinerstr.getLayoutY());
	    System.out.println(konstanzerstr.getLayoutX() + " "+ konstanzerstr.getLayoutY());
	    System.out.println(adenauerplatz.getLayoutX() + " "+ adenauerplatz.getLayoutY());
	    System.out.println(blissestr.getLayoutX() + " "+ blissestr.getLayoutY());
	    System.out.println(wilmersdorferstr.getLayoutX() + " "+ wilmersdorferstr.getLayoutY());
	    System.out.println(richardWagnerPlatz.getLayoutX() + " "+ richardWagnerPlatz.getLayoutY());
	    System.out.println(mierendorffplatz.getLayoutX() + " "+ mierendorffplatz.getLayoutY());
	    System.out.println(jungfernheide.getLayoutX() + " "+ jungfernheide.getLayoutY());
	    System.out.println(JakobKaiserPlatz.getLayoutX() + " "+ JakobKaiserPlatz.getLayoutY());
	    System.out.println(halemweg.getLayoutX() + " "+ halemweg.getLayoutY());
	    System.out.println(siemensdamm.getLayoutX() + " "+ siemensdamm.getLayoutY());
	    System.out.println(rohrdamm.getLayoutX() + " "+ rohrdamm.getLayoutY());
	    System.out.println(paulsternstr.getLayoutX() + " "+ paulsternstr.getLayoutY());
	    System.out.println(zitadelle.getLayoutX() + " "+ zitadelle.getLayoutY());
	    System.out.println(altstadtSpandau.getLayoutX() + " "+ altstadtSpandau.getLayoutY());
	    System.out.println("---------------");
	    System.out.println(berlinHbf.getLayoutX() + " "+ berlinHbf.getLayoutY());
	    System.out.println(bundestag.getLayoutX() + " "+ bundestag.getLayoutY());
	    System.out.println(brandenburgerTor.getLayoutX() + " "+ brandenburgerTor.getLayoutY());
	    System.out.println("---------------");
	    System.out.println(altMariendorf.getLayoutX() + " "+ altMariendorf.getLayoutY());
	    System.out.println(westphalweg.getLayoutX() + " "+ westphalweg.getLayoutY());
	    System.out.println(ullsteinstr.getLayoutX() + " "+ ullsteinstr.getLayoutY());
	    System.out.println(kaiserinAugustastr.getLayoutX() + " "+ kaiserinAugustastr.getLayoutY());
	    ...
	    System.out.println(schwartzkopffstr.getLayoutX() + " "+ schwartzkopffstr.getLayoutY());
	    System.out.println(reinickendorferstr.getLayoutX() + " "+ reinickendorferstr.getLayoutY());
	    System.out.println(wedding.getLayoutX() + " "+ wedding.getLayoutY());
	    System.out.println(leopoldplatz.getLayoutX() + " "+ leopoldplatz.getLayoutY());
	    System.out.println(seestr.getLayoutX() + " "+ seestr.getLayoutY());
	    System.out.println(rehberge.getLayoutX() + " "+ rehberge.getLayoutY());
	    System.out.println(afrikanischestr.getLayoutX() + " "+ afrikanischestr.getLayoutY());
	    System.out.println(kurtSchumacherPlatz.getLayoutX() + " "+ kurtSchumacherPlatz.getLayoutY());
	    System.out.println(scharnweberstr.getLayoutX() + " "+ scharnweberstr.getLayoutY());
	    System.out.println(otisstr.getLayoutX() + " "+ otisstr.getLayoutY());
	    
	    System.out.println("---------------");
	    System.out.println(ruhleben.getLayoutX() + " "+ ruhleben.getLayoutY());
	    System.out.println(olympiaStadion.getLayoutX() + " "+ olympiaStadion.getLayoutY());
	    System.out.println(newWestend.getLayoutX() + " "+ newWestend.getLayoutY());
	    System.out.println(theodorHeussPlatz.getLayoutX() + " "+ theodorHeussPlatz.getLayoutY());
	    System.out.println(kaiserdammStation.getLayoutX() + " "+ kaiserdammStation.getLayoutY());
	    System.out.println(sophieCharlottePlatz.getLayoutX() + " "+ sophieCharlottePlatz.getLayoutY());
	    System.out.println(bismarckstr.getLayoutX() + " "+ bismarckstr.getLayoutY());
	    System.out.println(deutscheOper.getLayoutX() + " "+ deutscheOper.getLayoutY());
	    System.out.println(ernstReuterPlatz.getLayoutX() + " "+ ernstReuterPlatz.getLayoutY());
	    System.out.println(berlinZoologischerGarten.getLayoutX() + " "+ berlinZoologischerGarten.getLayoutY());
	    System.out.println(mendelssohnBartholdyPark.getLayoutX() + " "+ mendelssohnBartholdyPark.getLayoutY());
	    System.out.println(potsdamerPlatz.getLayoutX() + " "+ potsdamerPlatz.getLayoutY());
	    System.out.println(mohrenstr.getLayoutX() + " "+ mohrenstr.getLayoutY());
	    ...
	    System.out.println(spichernstr.getLayoutX() + " "+ spichernstr.getLayoutY());
	    System.out.println(augsburgerStr.getLayoutX() + " "+ augsburgerStr.getLayoutY());
	    System.out.println("---------------");
